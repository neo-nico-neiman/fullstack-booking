...
public class RoomType {
	...
	public RoomType(String category, int maxGuestAAllowance, double pricePerNight, String imgURL, String roomInfo,
	...
	public String toString() {
		return "RoomType{" + "category='" + category + '\'' + ", maxGuestAAllowance=" + maxGuestAAllowance
				+ ", pricePerNight=" + pricePerNight + "imgURL: " + imageURL + " Room info: " + roomDetails + " "
				+ roomDescription + '}';
	}
}
