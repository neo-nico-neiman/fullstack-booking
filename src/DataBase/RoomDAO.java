...
public class RoomDAO {
	...
	public Room getRoom(int roomNumber) {
		...
		try {
			...
			String query = "SELECT  r.is_available, rt.category_name, rt.price_per_night,"
					+" rt.max_allowance, rt.image, rt.room_description, rt.room_details "
					+ "FROM rooms AS r "
