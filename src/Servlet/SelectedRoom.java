...
/**
 * Servlet that process and forward the Romm Number and Dates selected for reservation
 */
...
public class SelectedRoom extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		/*in case that customer change is mind and want to make
		 * reservation based on different parameters,
		 * then all parameters are removed from session
			*/
        ...
        /*add all values to session to allow user login on bookingRoom.jsp
        without loosing all selected values
        */
