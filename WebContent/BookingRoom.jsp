		...
		<div class="row  ">
			<div class="col-lg-8  card bg-light order-lg-first order-last">
				<form name="gInfo" class="d-flex flex-column needs-validation"
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="inputFName4">First Name</label> <input type="text"
								...
								placeholder="If you have two it's cool" value="<%=log_fName %>" required>
						...
						<div class="form-group col-md-6">
							<label for="inputLName4">Last Name</label> <input type="text"
								...
								placeholder="Surname or family name" value="<%=log_lName%>" required>
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="inputEmail4">E-mail</label> <input type="email"
								...
								placeholder="We care about your privacy " value="<%=log_email %>" required>
					...
					<div class="form-row">
						<div class="form-group col-md-6">
							<label for="inputCity">City</label> <input type="text"
								...
								value="<%=log_city%>" placeholder="The city where you live" required>
					...
					<div class="batches">
						<img src="img/SVG/americanexpress.svg" alt="amex">
						<img src="img/SVG/paypal.svg" alt="paypal">
						<img src="img/SVG/visa.svg" alt="visa">
						<img src="img/SVG/ripple.svg" alt="ripple">
						<img src="img/SVG/apple.svg" style="color: royalblue" alt="applepay">
					</div>
			...
			<div class="col-lg-3 ml-lg-4 card mb-4 mb-lg-0 order-lg-last order-first" >
